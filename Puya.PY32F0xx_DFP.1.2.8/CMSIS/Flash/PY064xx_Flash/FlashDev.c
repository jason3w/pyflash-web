 ...
 * $Revision:    V1.0.0
 *
 * Project:      Flash Device Description for Puya PY32L020xx Flash
 * --------------------------------------------------------------------------- */
...
struct FlashDevice const FlashDevice =
    {
        FLASH_DRV_VERS,          // Driver Version, do not modify!
        "Cortex-M0+ 18kB Flash", // Device Name (18kB)
        ONCHIP,                  // Device Type
        0x08000000,              // Device Start Address
        0x00004800,              // Device Size in Bytes (18kB)
        0x80,                    // Programming Page Size
        0,                       // Reserved, must be 0
        0xFF,                    // Initial Content of Erased Memory
        600,                     // Program Page Timeout 600 mSec
...
struct FlashDevice const FlashDevice =
    {
        ...
        // Specify Size and Address of Sectors
        0x0010, 0x000000, // Sector Size  16B (1 sectors)
        SECTOR_END};
#endif // FLASH_OB
